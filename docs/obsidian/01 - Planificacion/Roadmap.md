...
- Aquí podría incorporarse el concepto de **agente** → [[Arquitectura#Etapa avanzada]].
...
Cada versión se apoya en la anterior y se publica según [[Changelog]] y el control de versiones [[Git y GitHub]].
...
- [[Requisitos]] · Requisitos por versión.
