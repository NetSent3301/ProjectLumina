...
Configurados como variables CSS en `web/static/css/style.css` → [Frontend](Frontend.md).
...
- Móvil (≤880px): una columna; la sidebar colapsa a una franja con marca y reloj → [Frontend](Frontend.md).

---

## Relacionado

- [Frontend](Frontend.md) · dónde vive el código de la UI.
- [Dashboard](Dashboard.md) · pantalla que usa este sistema.
- [Decisiones](../06%20-%20Registro/Decisiones.md) · por qué HTML/CSS/JS.
- [Principios Tecnicos](../01%20-%20Planificacion/Principios%20Tecnicos.md) · simplicidad y observabilidad.
